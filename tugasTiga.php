...
<head>
    ...
    <style>
        body {
            ...
            background-color: #ffe4e1; /* Warna latar belakang pink muda */
            margin: 0;
            padding: 20px;
        }
        h1, h2 {
            color: #ff69b4; /* Warna judul menjadi pink */
        }
        table {
            width: 100%;
        ...
        table, th, td {
            border: 1px solid #ff69b4; /* Warna border tabel menjadi pink */
        }
        th, td {
            padding: 12px;
            text-align: left;
        ...
        th {
            background-color: #ffb6c1; /* Warna header tabel pink muda */
            color: white;
        }
        form {
            margin: 20px;
            padding: 20px;
            background-color: #fff0f5; /* Background form pink sangat muda */
            border-radius: 10px;
        ...
        label {
            ...
            margin-bottom: 10px;
            font-weight: bold;
            color: #ff1493; /* Warna label pink gelap */
        }
        input, textarea {
            width: 100%;
            padding: 10px;
        ...
        button {
            ...
            margin-top: 10px;
            font-size: 14px;
            background-color: #ff69b4; /* Tombol dengan warna pink */
            color: white;
        }
        button:hover {
            opacity: 0.8;
