...
<head>
    ...
    <style>
        ...
        h1, h2 {
            text-align: left;
            color: #ff69b4; /* Warna teks judul menjadi pink cerah */
        }
        table {
            width: 100%;
        ...
        table, th, td {
            border: 1px solid #ff69b4; /* Border warna pink cerah */
        }
        th, td {
            padding: 12px;
            text-align: left;
        ...
        form {
            margin: 20px;
            padding: 20px;
            background-color: #fff0f5; /* Background form pink muda */
            border-radius: 10px;
        ...
        label {
            ...
            margin-bottom: 10px;
            font-weight: bold;
            color: #ff1493; /* Warna teks label pink gelap */
        }
        input, textarea {
            width: 100%;
            padding: 10px;
